    ...
    <footer className="border-t border-border bg-charcoal text-cream">
      <div className="container py-16">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mb-6 max-w-md text-sm leading-relaxed opacity-70">
              Dermatologia avançada com atendimento humanizado. Tratamentos personalizados 
              para cuidar da saúde e beleza da sua pele com segurança e profissionalismo.
            </p>
            <div className="flex gap-4">
              <a
                href="#"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-cream/10 transition-colors hover:bg-gold"
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm opacity-70">
              ...
              <li className="flex items-center gap-2">
                ...
                <span>contato@clinicalacerda.com.br</span>
              </li>
            </ul>
          </div>
      ...
      <div className="border-t border-cream/10 py-6">
        <div className="container flex flex-col items-center justify-between gap-4 text-center text-xs opacity-50 sm:flex-row sm:text-left">
          ...
          <p>Dra. Lorena Lacerda - CRM XXXXX | RQE XXXXX</p>
        </div>
      </div>
    </footer>
  );
